...
const greeting = {
  username: "mukundh kamatham",
  title: "Hi all, I'm Mukunda",
  subTitle: emoji(
  ...
  schools: [
    {
      ...
      descBullets: [
        "Solved more than 200+ DSA problems",
        "attended more than 100 hours of communication classes"
      ]
    },
    {
...
const bigProjects = {
  ...
  projects: [
    ...
    {
      image: require("./assets/images/picsss1.png"),
      projectName: "FABALLEY CLONE",
      projectDesc:
        "FabAlley.com is an online fashion store for taste-makers and trend-breakers all over the country. online shopping for women looking for the latest fashion trends, FabAlley is the one-stop destination.",
      stack: "  HTML5  | CSS | JAVASCRIPT | MONGODB | NODE | REACT",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://github.com/mukundakamatham/faballey-clone"
        },
        {
          name: "Website Demo",
          url: "https://faballey-clone.herokuapp.com/"
        }
      ]
    }
  ],
